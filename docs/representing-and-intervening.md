...
You'll see Claude slow down. Instead of immediately suggesting a fix, it names two or more possible causes, predicts an observable difference between them, and tests the cheapest one first. If the first test doesn't distinguish, it picks another.
